...
for j in probability_thresholds:
    ...
    fpr, tpr, thresholds = metrics.roc_curve(Yt, p)
...
ax.plot(l2_recall_scores, l2_precision_scores, label='Hybrid ANN-LSTM : AUC = '+str(auc_l))
ax.plot(l2_recall_scores1, l2_precision_scores1, label='Hybrid ANN-BiLSTM : AUC = '+str(auc_bl))
